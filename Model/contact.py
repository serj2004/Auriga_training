...
class Contact:
    ...
    def __init__(self, firstname=None, middlename=None, lastname=None, nickname=None, title=None,
                 ...
                 email2=None, email3=None, homepage=None, bday=None, bmonth=None, byear=None, address2=None,
    ...
    def __eq__(self, other):
        return (self.id is None or other.id is None or self.id == other.id) \
               and self.firstname == other.firstname and self.lastname == other.lastname and self.firstname == \
               other.firstname and self.lastname == other.lastname and self.address == other.address \
